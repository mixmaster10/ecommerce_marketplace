...
const StoresPage = () => {
    ...
    return (
        <div className="site-content">
            ...
            <HeaderMobile />
            <NavigationList />
            <div id="___stores-page-container">
                ...
                <main id="___main-content-container">
                    <SearchBar />
                    <NewStoresPannel
                        suggestedStores={stores.suggestedStores}
                        topBrands={stores.topBrands}
                        popularStores={stores.popularStores}
                    />
                    <StoreCategories storeCategories={stores.storeCategories} />
                    <CurrentStoresPannel stores={stores.stores} />
                </main>
            </div>
        </div>
    );
