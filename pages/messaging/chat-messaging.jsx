...
const ChatMessaging = () => {
    ...
    return (
        <div className="chat-messaging">
            ...
            <div className="chat-msg-box chat-box">
                ...
                <div className="chat-msg-content">
                    <div className="chat">
                        <div className="chat-img">
                            ...
                            <span className="activity">1:42 PM .....</span>
                        </div>
                    ...
                    <div className="chat chat-right">
                        <div className="chat-img">
                            <span className="activity">1:46 PM .....</span>
                            <a href="javascript:void(0)">
                                <div className="chat-bg-img">
                                    <img className="img-fluid" src="https://images.unsplash.com/photo-1590086783191-a0694c7d1e6e?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80" alt="" />
                                </div>
                        ...
                        <div className="chat-msg-text">
                            <p>First of all, you need to understand the subject matter thoroughly. You need to know what is warming, what causes global warming, and what  people should do to abate the effects of global warming.....</p>
                        </div>
                    </div>
                    ...
                    <div className="chat">
                        ...
                        <div className="chat-msg-text">
                            <p>I have done a lot of research on the subject,and I know I can answer any questions I will receive from the audience.....</p>
                        </div>
                    </div>
                    ...
                    <div className="chat">
                        ...
                        <div className="chat-msg-text">
                            <p>I should talk about more precisely the sequence of my presentation?.....</p>
                        </div>
                    </div>
                ...
                <div className="chat-message-input-box d-flex justify-content-center align-items-center">
