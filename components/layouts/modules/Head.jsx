...
const StyleSheets = () => (
    <Head>
        <title>Bluejestic Social Marketplace</title>
        <link rel="shortcut icon" href="/static/img/favicons/icon.png" />
        <link rel="icon" href="/static/img/favicons/icon.png" sizes="32x32" />
        <link rel="icon" href="/static/img/favicons/icon.png" sizes="192x192" />
        <link
            rel="apple-touch-icon-precomposed"
            href="/static/img/logo-b.png"
        />
        <link
            rel="stylesheet"
            type="text/css"
